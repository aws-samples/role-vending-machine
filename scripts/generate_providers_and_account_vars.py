...
def main():
    ...
    with open("role-vending-machine/providers.tf", "w") as f:
        f.write(
            f"# DO NOT EDIT! Automatically generated by scripts/generate_providers_and_account_vars.py\n"
        )
        f.write(
            f"# To Rebuild providers.tf, execute the generate_providers_and_account_vars GitHub workflow.\n\n\n"
        )
        ...
        for account in account_list:
            provider_text = 'provider "aws" {\n'
            provider_text += f'  alias  = "{account.get("Name").replace(" ","_")}"\n'
            provider_text += f'  region = "{AWS_REGION}"\n'
            provider_text += "  assume_role {\n"
            provider_text += (
                f'    role_arn = "arn:aws:iam::{account.get("Id")}:role/{RVM_ROLE}"\n'
            )
            provider_text += "  }\n"
            provider_text += "}"
            provider_text += "\n\n"
    ...
    with open("role-vending-machine/variables-accounts.tf", "w") as f:
        f.write(
            f"# DO NOT EDIT! Automatically generated by scripts/generate_providers_and_account_vars.py\n"
        )
        f.write(
        ...
        for account in account_list:
            variable_text = (
                f'variable "account_{account.get("Name").replace(" ","_")}" {{\n'
            )
